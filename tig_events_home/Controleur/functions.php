...
function conditions_de_recherche($eventschoice){

		switch ($eventschoice) {
			case '0':
			$param = "EVT0' OR bx_events_main.Type='EVT1' OR bx_events_main.Type='EVT2' OR bx_events_main.Type='EVT3' OR bx_events_main.Type='EVT4' OR bx_events_main.Type='EVT5' OR bx_events_main.Type='EVT6' OR bx_events_main.Type='EVT7' OR bx_events_main.Type='EVT8";
			break;
