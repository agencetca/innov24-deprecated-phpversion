...
$groupschoice = 0;
}else {$groupschoice = $_SESSION['' . $nom_module . '_current_position'];}

//On va chercher les paramètres de la recherche
$param = conditions_de_recherche($groupschoice);

//On affiche le menu
include(BX_DIRECTORY_PATH_ROOT.'tig_groups_home/Vue/menu.php');
...
include(BX_DIRECTORY_PATH_ROOT.'tig_groups_home/Vue/popups.php');		
...
?>
<script src="tig_groups_home/Controleur/wallajax.js"></script>

<script src="tig_groups_home/Vue/ajaxbox.js"></script>
...
// 	$('#popup_share_groups').mouseover(function() {
// 	$('body').css( "overflow", "hidden" );
// });
// 
// 	$('#popup_share_groups').mouseout(function() {
// 	$('body').css( "overflow", "scroll" );
// });


function share_groups() 
{
...
var lkey = '_ibdw_evowall_bx_gruppo_add_condivisione';
	...
	$.get('tig_groups_home/Modele/db_share.php', {sender:sender,receiver:receiver,postid:postid,memberID:memberID}, function(data) {
		$.get('tig_groups_home/Modele/share_ajax.php', {postid:postid}, function(responseText) {
