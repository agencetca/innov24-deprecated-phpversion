...
//====================================================================================================================//
				...
				$LienPost = "m/groups/view/".$contenu['uri']."";

				//On prépare l'affichage des sur-catégories (les 'Types' de fawn)
				$SurCategorie = _t('_bx_group_Groups');
				...
				if ($contenu['allow_view_group_to'] == 3){
				$PrivacyDiv = '<div class="privacypic4"></div>';
				}
				else if ($contenu['allow_view_group_to'] == 4){
				$PrivacyDiv = '<div class="privacypic1"></div>';
				}
				else if ($contenu['allow_view_group_to'] == 5){
...
// 				$PaiementStatut = _t('_free_news');
				...
				$postid[$i]= $contenu['id'];
				$post_url[$i] = 'm/groups/view/'.preg_replace('#(\x5c)*(\')*(")*#', "", $contenu['uri']);
