...
function conditions_de_recherche($groupschoice){

		switch ($groupschoice) {
			case '0':
			$param = "GT0' OR bx_groups_main.type='GT1' OR bx_groups_main.type='GT2' OR bx_groups_main.type='GT3' OR bx_groups_main.type='GT4' OR bx_groups_main.type='GT5' OR bx_groups_main.type='GT6' OR bx_groups_main.type='GT7' OR bx_groups_main.type='GT8";
			break;
