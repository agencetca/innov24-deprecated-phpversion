...
function conditions_de_recherche($storechoice){

		switch ($storechoice) {
			case '0':
			$param = "STO0' OR bx_store_products.StoreType='STO1' OR bx_store_products.StoreType='STO2' OR bx_store_products.StoreType='STO3' OR bx_store_products.StoreType='STO4' OR bx_store_products.StoreType='STO5' OR bx_store_products.StoreType='STO6' OR bx_store_products.StoreType='STO7' OR bx_store_products.StoreType='STO8";
			break;
    ...
    // Request aims to fetch the list of privacy_store which I belong in a string
    ...
    // Request aims to fetch the list of privacy_store which I own in a string
