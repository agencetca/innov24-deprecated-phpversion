...
$storechoice = 0;
}else {$storechoice = $_SESSION['' . $nom_module . '_current_position'];}

//On va chercher les paramètres de la recherche
$param = conditions_de_recherche($storechoice);

//On affiche le menu
include(BX_DIRECTORY_PATH_ROOT.'tig_store_home/Vue/menu.php');
	...
	echo '<ul id="content" style="padding: 0; margin: 0; outline: 0;">';
		...
		echo '<div id="wall">';
			...
			$resultat = bring_it($default_behaviour,$param,$Limit,$SpecialParamWhere,$innov24_config,$bigfriendlist,$privacy_OthersToMe,$privacy_MeToOthers);
				...
				require(BX_DIRECTORY_PATH_ROOT.'tig_store_home/store_prereq.php');
...
include(BX_DIRECTORY_PATH_ROOT.'tig_store_home/Vue/popups.php');		
...
?>
<script src="tig_store_home/Controleur/wallajax.js"></script>

<script src="tig_store_home/Vue/ajaxbox.js"></script>
...
// 	$('#popup_share_store').mouseover(function() {
// 	$('body').css( "overflow", "hidden" );
// });
// 
// 	$('#popup_share_store').mouseout(function() {
// 	$('body').css( "overflow", "scroll" );
// });


function share_store() 
{

var lkey = '_ibdw_evowall_bx_gruppo_add_condivisione';
	...
	$.get('tig_store_home/Modele/db_share.php', {sender:sender,receiver:receiver,postid:postid,memberID:memberID}, function(data) {
		$.get('tig_store_home/Modele/share_ajax.php', {postid:postid}, function(responseText) {
