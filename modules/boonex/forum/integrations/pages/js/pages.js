function delPhotoField( url, dumb_id, id )
{
	...
	var urlAbs = url + '/' + dumb_id + '/' + id + mytime;
alert(urlAbs); return;
	...
	oXMLHttpReq.open( "GET", urlAbs );
	oXMLHttpReq.onreadystatechange = function()
	{
		//if ( oXMLHttpReq.readyState == 4 && oXMLHttpReq.status == 200 )
			//document.getElementById( elID ).innerHTML = oXMLHttpReq.responseText;
...
BxDolPFMArea.prototype.activateSortable = function() {
    ...
    $('.blocks_container', this.element).sortable('destroy').sortable({
...
function changeFieldType( _type ) {
	...
	switch( _type ) {
		case 'text':
			aShow = new Array( 'field_control_media_type', 'field_link', 'field_with_photo', 'field_multiplecss', 'field_multiplestyle', 'field_minimum', 'field_maximum', 'field_unique', 'field_check', 'field_minimum_msg', 'field_maximum_msg', 'field_unique_msg', 'field_check_msg', 'field_default', 'field_multiplyable' );
			aHide = new Array( 'field_control_attribute', 'field_with_time', 'field_add_on', 'field_id_field', 'field_caption_field', 'field_dep_field', 'field_dep_parent_field','field_control_select_one', 'field_control_select_set', 'field_values', 'field_lkey' );
		break;
		case 'area':
			aShow = new Array( 'field_default', 'field_multiplecss', 'field_multiplestyle', 'field_multiplyable', 'field_minimum', 'field_maximum', 'field_unique', 'field_check', 'field_minimum_msg', 'field_maximum_msg', 'field_unique_msg', 'field_check_msg' );
			aHide = new Array( 'field_control_attribute', 'field_with_time', 'field_control_media_type', 'field_add_on', 'field_id_field', 'field_with_photo', 'field_caption_field', 'field_dep_field', 'field_dep_parent_field','field_link', 'field_control_select_one', 'field_control_select_set', 'field_values', 'field_lkey' );
		break;
		case 'pass':
			aShow = new Array( 'field_minimum', 'field_maximum', 'field_check', 'field_minimum_msg', 'field_maximum_msg', 'field_check_msg' );
			aHide = new Array( 'field_control_attribute', 'field_with_time', 'field_control_media_type', 'field_add_on', 'field_id_field', 'field_caption_field', 'field_dep_field', 'field_dep_parent_field','field_link', 'field_multiplecss', 'field_multiplestyle', 'field_with_photo', 'field_multiplyable', 'field_control_select_one', 'field_control_select_set', 'field_unique', 'field_unique_msg', 'field_values', 'field_default', 'field_lkey' );
		break;
		case 'date':
			aShow = new Array( 'field_with_time', 'field_minimum', 'field_maximum', 'field_check', 'field_minimum_msg', 'field_maximum_msg', 'field_check_msg', 'field_default' );
			aHide = new Array( 'field_control_attribute', 'field_control_media_type', 'field_add_on', 'field_id_field', 'field_caption_field', 'field_dep_field', 'field_dep_parent_field','field_link', 'field_multiplecss', 'field_multiplestyle', 'field_with_photo', 'field_multiplyable', 'field_control_select_one', 'field_control_select_set', 'field_unique', 'field_unique_msg', 'field_values', 'field_lkey' );
		break;
		case 'select_one':
			aShow = new Array( 'field_control_attribute', 'field_id_field', 'field_caption_field', 'field_dep_field', 'field_dep_parent_field', 'field_link', 'field_multiplecss', 'field_multiplestyle', 'field_control_select_one', 'field_values', 'field_default', 'field_lkey' );
			aHide = new Array( 'field_add_on', 'field_multiplyable', 'field_with_time', 'field_control_media_type', 'field_with_photo', 'field_minimum', 'field_maximum', 'field_unique', 'field_check', 'field_control_select_set', 'field_minimum_msg', 'field_maximum_msg', 'field_unique_msg', 'field_check_msg' );
		break;
		case 'select_set':
			aShow = new Array( 'field_control_select_set', 'field_values', 'field_lkey' );
			aHide = new Array( 'field_control_attribute', 'field_with_time', 'field_control_media_type', 'field_add_on', 'field_id_field', 'field_caption_field', 'field_dep_field', 'field_dep_parent_field','field_link', 'field_multiplecss', 'field_multiplestyle', 'field_with_photo', 'field_multiplyable', 'field_minimum', 'field_maximum', 'field_control_select_one', 'field_default', 'field_unique', 'field_check', 'field_minimum_msg', 'field_maximum_msg', 'field_unique_msg', 'field_check_msg' );
		break;
		case 'num':
			...
			aHide = new Array( 'field_control_attribute', 'field_with_time', 'field_control_media_type', 'field_add_on', 'field_id_field', 'field_caption_field', 'field_dep_field', 'field_dep_parent_field','field_link', 'field_multiplecss', 'field_multiplestyle', 'field_with_photo', 'field_multiplyable', 'field_control_select_one', 'field_control_select_set', 'field_values', 'field_lkey' );
		break;
		case 'range':
		...
		case 'bool':
			...
			aHide = new Array( 'field_control_attribute', 'field_with_time', 'field_control_media_type', 'field_add_on', 'field_id_field', 'field_caption_field', 'field_dep_field', 'field_dep_parent_field','field_link', 'field_multiplecss', 'field_multiplestyle', 'field_with_photo', 'field_multiplyable', 'field_control_select_one', 'field_control_select_set', 'field_unique', 'field_minimum', 'field_maximum', 'field_check', 'field_minimum_msg', 'field_maximum_msg', 'field_unique_msg', 'field_check_msg', 'field_values', 'field_lkey' );
		break;
		/*case 'photo':
			aShow = new Array( 'fieldphotofor', 'field_multiplyable');
			aHide = new Array( 'field_multiplecss', 'field_multiplestyle', 'field_default', 'field_control_select_one', 'field_control_select_set', 'field_unique', 'field_minimum', 'field_maximum', 'field_check', 'field_minimum_msg', 'field_maximum_msg', 'field_unique_msg', 'field_check_msg', 'field_values', 'field_lkey' );
		break;*/
	}
...
function genEditFormError( sField, sText ) {
	if( document.forms.fieldEditForm[sField] ) {
		$( document.forms.fieldEditForm[sField] ).parent( 'td' ).next( 'td' ).prepend(
