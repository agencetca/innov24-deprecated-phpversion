...
class MlPagesPSFM {
	...
	function genFieldEditForm( $iItemID ) {
		...
		if( $aField['Type'] == 'block' ) {
			...
			<tr>
				<td class="label"><?= _t('_ml_fields_builder_disable_caption') ?>:</td>
				<td class="value">
						<input type="checkbox" name="CaptionDisable" value="" class="input_checkbox"
						<?= $aField['CaptionDisable'] ? 'checked="checked"' : '' ?> />
				</td>
				<td class="info">
					<?= $this -> getInfoIcon( _t('_ml_fields_builder_disable_caption_desc')); ?>
				</td>
			</tr>
			<?
		}
	...
	function genFormAdvTab( $aField ) {
		...
		$aForm = array(
			...
			'Attribute' => array(
				'label'  => _t('_ml_fields_builder_adm_fields_attribute'),
				'type'   => 'select',
				'info'   => addslashes(_t('_ml_fields_builder_adm_fields_attribute_desc')),
			...
			'IdField' => array(
				'label'  => _t('_ml_fields_builder_adm_fields_id_field'),
				'type'   => 'text',
				'info'   => addslashes(_t('_ml_fields_builder_adm_fields_id_field_desc')),
				'value'  => $aField['IdField'],
				'row_id' => 'field_id_field'
			),
			'CaptionField' => array(
				'label'  => _t('_ml_fields_builder_adm_fields_caption_field'),
				'type'   => 'text',
				'info'   => addslashes(_t('_ml_fields_builder_adm_fields_caption_field_desc')),
				'value'  => $aField['CaptionField'],
				'row_id' => 'field_caption_field'
			),
			'DepField' => array(
				'label'  => _t('_ml_fields_builder_adm_fields_dep_field'),
				'type'   => 'text',
				'info'   => addslashes(_t('_ml_fields_builder_adm_fields_dep_field_desc')),
				'value'  => $aField['DepField'],
				'row_id' => 'field_dep_field'
			),
			'DepParentField' => array(
				'label'  => _t('_ml_fields_builder_adm_fields_dep_parent_field'),
				'type'   => 'text',
				'info'   => addslashes(_t('_ml_fields_builder_adm_fields_dep_parent_field_desc')),
				'value'  => $aField['DepParentField'],
				'row_id' => 'field_dep_parent_field'
			),
			'MediaType' => array(
				'label'  => _t('_ml_fields_builder_adm_fields_media_type'),
				'type'   => 'select',
				'info'   => addslashes(_t('_ml_fields_builder_adm_fields_media_type_desc')),
			...
			/*'WithPhoto' => array(
				'label'  => _t('_ml_fields_builder_adm_fields_with_photo'),
				'type'   => 'checkbox',
				'info'   => addslashes(_t('_ml_fields_builder_adm_fields_with_photo_desc')),
				'value'  => $aField['WithPhoto'],
				'row_id' => 'field_with_photo'
			),*/
			'WithTime' => array(
				'label'  => _t('_ml_fields_builder_adm_fields_with_time'),
				'type'   => 'checkbox',
				'info'   => addslashes(_t('_ml_fields_builder_adm_fields_with_time_desc')),
			...
			'Values' => array(
				'label'  => _t('_ml_fields_builder_adm_fields_values'),
				'type'   => 'values',
				'info'  => addslashes(_t('_ml_fields_builder_adm_fields_values_desc')),
				'value'  => $aField['Values'],
				'row_id' => 'field_values'
			),
			'UseLKey' => array(
			...
			'Default' => array(
				'label'  => _t('_ml_fields_builder_adm_fields_default'),
				'type'   => 'text',
				'info'  => addslashes(_t('_ml_fields_builder_adm_fields_default_desc')),
