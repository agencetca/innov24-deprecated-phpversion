...
ml_pages_import ('FormEdit');

class MlPagesFormUploadMedia extends MlPagesFormEdit {

    function MlPagesFormUploadMedia ($oMain, $iProfileId, $iEntryId, &$aDataEntry, $sMedia, $aMediaFields) {

        parent::MlPagesFormEdit ($oMain, $iProfileId, $iEntryId, $aDataEntry);
