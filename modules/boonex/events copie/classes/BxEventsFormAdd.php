...
class BxEventsFormAdd extends BxDolFormMedia {
    ...
    function BxEventsFormAdd ($oMain, $iProfileId, $iEntryId = 0, $iThumb = 0) {
        ...
        asort($aCountries);
        $aTypes = $oProfileFields->convertValues4Input('#!EventType');
        asort($aTypes);
        ...
        $aCustomForm = array(
            ...
            'inputs' => array(
				...
				'Type' => array(
                    'type' => 'select',
                    'name' => 'Type',
                    'caption' => _t('_bx_events_form_caption_type'),
                    'values' => $aTypes,
                    'required' => true,
                    'checker' => array (
                        'func' => 'preg',
                    ...
                    'db' => array (
                        'pass' => 'Preg', 
                        'params' => array('/([A-Za-z0-9]{3,6})/'),//Regular expression permet A ‡ Z et 0 ‡ 9 longueur entre 3 et 4 caractËres ^^
                    ),
                    'display' => true,
                ),
                'Title' => array(
                ...
                'Categories' => $oCategories->getGroupChooser ('bx_events', (int)$iProfileId, true), 
				 ...
				 'Active_Event' => array(
					...
					'caption' => _t('_bx_events_caption_open'),
