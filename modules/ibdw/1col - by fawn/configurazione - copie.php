 ...
 <div class="semicolumn">
   ...
   <div class="spazio"></div>
	<form action="updateconfig.php" method="POST">
	 ...
	 <div class="contentcon">
	  ...
	  <div class="unsesto">Gigs</div><div class="unquarto"><input type="radio" name="gigsvar" value="ON" <?php if($rowconfig['gigsvar']=='ON') {echo 'checked';}?>/>ON <input type="radio" name="gigsvar" value="OFF" <?php if($rowconfig['gigsvar']=='OFF') {echo 'checked';}?>/>OFF</div>
	 </div>
	 	<div class="contentcon">
	  <div class="unsesto">File</div><div class="unquarto"><input type="radio" name="file" value="ON" <?php if($rowconfig['file']=='ON') {echo 'checked';}?>/>ON <input type="radio" name="file" value="OFF" <?php if($rowconfig['file']=='OFF') {echo 'checked';}?>/>OFF</div>
	 ...
	 <div class="contentcon">
	  <div class="unsesto">Sound</div><div class="unquarto"><input type="radio" name="sound" value="ON" <?php if($rowconfig['suoni']=='ON') {echo 'checked';}?>/>ON <input type="radio" name="sound" value="OFF" <?php if($rowconfig['suoni']=='OFF') {echo 'checked';}?>/>OFF</div>
	<div class="unsesto">Articles</div><div class="unquarto"><input type="radio" name="topicvar" value="ON" <?php if($rowconfig['topicvar']=='ON') {echo 'checked';}?>/>ON <input type="radio" name="topicvar" value="OFF" <?php if($rowconfig['topicvar']=='OFF') {echo 'checked';}?>/>OFF</div>
	<div class="contentcon">
	</div>
	  <div class="unsesto">Tchat</div><div class="unquarto"><input type="radio" name="tchatvar" value="ON" <?php if($rowconfig['tchatvar']=='ON') {echo 'checked';}?>/>ON <input type="radio" name="tchatvar" value="OFF" <?php if($rowconfig['tchatvar']=='OFF') {echo 'checked';}?>/>OFF</div>
	  <div class="unsesto">Wall</div><div class="unquarto"><input type="radio" name="wallvar" value="ON" <?php if($rowconfig['wallvar']=='ON') {echo 'checked';}?>/>ON <input type="radio" name="wallvar" value="OFF" <?php if($rowconfig['wallvar']=='OFF') {echo 'checked';}?>/>OFF</div>	
	<div class="contentcon">
	</div>
		<div class="unsesto">Blog</div><div class="unquarto"><input type="radio" name="blogvar" value="ON" <?php if($rowconfig['blogvar']=='ON') {echo 'checked';}?>/>ON <input type="radio" name="blogvar" value="OFF" <?php if($rowconfig['blogvar']=='OFF') {echo 'checked';}?>/>OFF</div>
		<div class="unsesto">Alerts</div><div class="unquarto"><input type="radio" name="alertvar" value="ON" <?php if($rowconfig['alertvar']=='ON') {echo 'checked';}?>/>ON <input type="radio" name="alertvar" value="OFF" <?php if($rowconfig['alertvar']=='OFF') {echo 'checked';}?>/>OFF</div>
	<div class="contentcon">
	</div>
	<div class="unquarto"></div>
	 </div>
	 <div class="spazio"></div>
	 <span class="introtitle">Avatar preference and Nick Name Format</span><br/>
   <span class="introdesc">Choose what should be appear</span>
   <div class="spazio"></div>
   <div class="contentcon">
	 
   <div class="unsesto">Avatar type:</div>
      <div class="unquarto">
          <input type="radio" name="avatartype" value="simple" <?php if($rowconfig['avatartype']=='simple') {echo 'checked';}?>/>Simple <br/>
          <input type="radio" name="avatartype" value="standard" <?php if($rowconfig['avatartype']=='standard') {echo 'checked';}?>/>Standard
    </div>
  ...
  <div class="unsesto">Display Status</div>
      <div class="unquarto">
          ...
          <input type="radio" name="status" value="OFF" <?php if($rowconfig['status']=='OFF') {echo 'checked';}?>/>OFF</div>
          
   <div class="unsesto">Show City:</div>
      <div class="unquarto">
          <input type="radio" name="city" value="ON" <?php if($rowconfig['city']=='ON') {echo 'checked';}?>/>ON 
          <input type="radio" name="city" value="OFF" <?php if($rowconfig['city']=='OFF') {echo 'checked';}?>/>OFF</div> 
   ...
   <div class="unsesto">Implode more link:</div>
      ...
      <div class="unsesto">Fade duration:</div> <br/>
 ...
 <div id="contentbox" style="line-height: 31px;">
   <span class="introtitle">Custom Section</span><br/>
      ...
      1 link. <input type="text" name="customlinksect1" value="<?php echo $rowconfig['customsect1'];?>" />
		...
		<br /><span>language key : _ibdw_1col_customsect1</span><span> : </span><span><?php echo _t('_ibdw_1col_customsect1'); ?></span><br />
 ...
 <div class="semicolumn"> 
  ...
  <div id="contentbox">
   ...
   <span class="introtitle">Display the main links section</span><br/>
	...
	<span class="introtitle">Display the market place links section</span><br/>
    <input type="radio" name="marketvar" value="ON" <?php if($rowconfig['marketvar']=='ON') {echo 'checked';}?>/>ON
	 <input type="radio" name="marketvar" value="OFF" <?php if($rowconfig['marketvar']=='OFF') {echo 'checked';}?>/>OFF
    <br/><br/>
	
	<span class="introtitle">Display the Alerts links section</span><br/>
    <input type="radio" name="alertevar" value="ON" <?php if($rowconfig['alertevar']=='ON') {echo 'checked';}?>/>ON
	 <input type="radio" name="alertevar" value="OFF" <?php if($rowconfig['alertevar']=='OFF') {echo 'checked';}?>/>OFF
    <br/><br/>
   ...
   <span class="introtitle">Display the online friends section</span><br/>
	...
	<input type="radio" name="deletebutton" value="OFF" <?php if($rowconfig['deletebutton']=='OFF') {echo 'checked';}?>/>OFF
      <br/>
        ...
        <span class="introtitle">Manage URL</span><br/>
        
        <div id="simula_left">
        Mail: <br/><input type="text" name="mailurl" value="<?php echo $rowconfig['mailurl'];?>" size="26"><br/><br/>
        Group:<br/> <input type="text" name="groupurl" value="<?php echo $rowconfig['groupurl'];?>" size="26"><br/> <br/>
        Add group:<br/> <input type="text" name="addgroupurl" value="<?php echo $rowconfig['addgroupurl'];?>" size="26"><br/><br/>
         Event:<br/> <input type="text" name="eventurl" value="<?php echo $rowconfig['eventurl'];?>" size="26"><br/>  <br/>
          Add event:<br/> <input type="text" name="addeventurl" value="<?php echo $rowconfig['addeventurl'];?>" size="26"><br/><br/>
           Poll:<br/> <input type="text" name="pollurl" value="<?php echo $rowconfig['pollurl'];?>" size="26"><br/>    <br/>
            Add poll:<br/> <input type="text" name="addpollurl" value="<?php echo $rowconfig['addpollurl'];?>" size="26"><br/> <br/>
            Ads:<br/> <input type="text" name="adsurl" value="<?php echo $rowconfig['adsurl'];?>" size="26"><br/>  <br/>
           Add ads:<br/> <input type="text" name="addadsurl" value="<?php echo $rowconfig['addadsurl'];?>" size="26"><br/><br/> 
		   Gigs :<br/> <input type="text" name="gigsurl" value="<?php echo $rowconfig['gigsurl'];?>" size="26"><br/> <br/>
		   Gigs Services:<br/> <input type="text" name="gigsserv" value="<?php echo $rowconfig['gigsserv'];?>" size="26"><br/> <br/>
		   Store :<br/> <input type="text" name="storeurl" value="<?php echo $rowconfig['storeurl'];?>" size="26"><br/> <br/>
		   Store Services:<br/> <input type="text" name="storeserv" value="<?php echo $rowconfig['storeserv'];?>" size="26"><br/> <br/>
		   Tchat :<br/> <input type="text" name="tchaturl" value="<?php echo $rowconfig['tchaturl'];?>" size="26"><br/> <br/>
		   Blog :<br/> <input type="text" name="blogurl" value="<?php echo $rowconfig['blogurl'];?>" size="26"><br/> <br/>
		   Add Blog :<br/> <input type="text" name="addblogurl" value="<?php echo $rowconfig['addblogurl'];?>" size="26"><br/> <br/>
          </div>
          <div id="simula_right">
            Site:<br/> <input type="text" name="siteurl" value="<?php echo $rowconfig['siteurl'];?>" size="26"><br/><br/>
             File: <br/><input type="text" name="fileurl" value="<?php echo $rowconfig['fileurl'];?>" size="26"><br/> <br/> 
            Add file:<br/> <input type="text" name="addfileurl" value="<?php echo $rowconfig['addfileurl'];?>" size="26"><br/>  <br/>
            Add site:<br/> <input type="text" name="addsiteurl" value="<?php echo $rowconfig['addsiteurl'];?>" size="26"><br/> <br/>
            Photo:<br/> <input type="text" name="photourl" value="<?php echo $rowconfig['photourl'];?>" size="26"><br/>   <br/>
			Add Photo:<br/> <input type="text" name="addphotourl" value="<?php echo $rowconfig['addphotourl'];?>" size="26"><br/>   <br/>
            Video:<br/> <input type="text" name="videourl" value="<?php echo $rowconfig['videourl'];?>" size="26"><br/> <br/>
			Add Video:<br/> <input type="text" name="addvideourl" value="<?php echo $rowconfig['addvideourl'];?>" size="26"><br/> <br/>
            Sound:<br/> <input type="text" name="soundurl" value="<?php echo $rowconfig['soundurl'];?>" size="26"><br/>  <br/>
			Add Sound:<br/> <input type="text" name="addsoundurl" value="<?php echo $rowconfig['addsoundurl'];?>" size="26"><br/>  <br/>
            Avatar:<br/> <input type="text" name="avatarurl" value="<?php echo $rowconfig['avatarurl'];?>" size="26"><br/>  <br/>
			Articles :<br/> <input type="text" name="topicurl" value="<?php echo $rowconfig['topicurl'];?>" size="26"><br/> <br/>
		   Articles Services:<br/> <input type="text" name="topicserv" value="<?php echo $rowconfig['topicserv'];?>" size="26"><br/> <br/>
		   Wall :<br/> <input type="text" name="wallurl" value="<?php echo $rowconfig['wallurl'];?>" size="26"><br/> <br/>
		   Alerts :<br/> <input type="text" name="alerturl" value="<?php echo $rowconfig['alerturl'];?>" size="26"><br/> <br/>
		   Add Alerts :<br/> <input type="text" name="addalert" value="<?php echo $rowconfig['addalert'];?>" size="26"><br/> <br/>
          </div>
 </div>
</div>
</div>
