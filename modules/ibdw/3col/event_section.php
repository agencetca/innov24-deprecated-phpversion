<?php
 ...
 for ($sfoglia=0;$sfoglia<$contaamici;$sfoglia++)
 {
	...
	{
	 $queryeventi=$queryeventi . $amico[$sfoglia] . " OR `ResponsibleID`=".$userid;
	}
 } 
 ...
 if ($contaeventi>0)
 {
  ...
  echo '<div class="rigamenumodificadplop"><div class="titleeventirec">'._t('_ibdw_thirdcolumn_event').'</div></div>';
