...
if(!PommoMailCtl::spawn($pommo->_baseUrl.'support/tests/mailing.test2.php?code='.$code,true)) 
	Pommo::kill('Initial Spawn Failed! You must correct this before you can send mailings.');
...
if (!is_file($pommo->_workDir . '/mailing.test.php')) {
	...
	Pommo::kill('Initial Spawn Failed (test file not written)! You must correct this before you can send mailings.');
}
