...
mysql_query("truncate table pommo_subscribers");
$result = mysql_query("SELECT * FROM Profiles") or die('Error: ' . mysql_error());
while ($row = mysql_fetch_array($result))
{
$subscriber_id = $row['ID'];
$email = $row['Email'];
$nickname = $row['NickName'];
$timeregistered = $row['DateReg'];
mysql_query("INSERT INTO `pommo_subscribers` VALUES('', '$email', '$nickname', '$timeregistered', '', '000-000-000', '1')") or die (mysql_error());
}
