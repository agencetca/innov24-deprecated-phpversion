...
<p>{t escape=no 1="<strong>$exchanger</strong>"}A test message will be sent to the supplied recipient. If you receive it, you can use the %1 exchanger. Remember to check your SPAM folder too.{/t}</p>
