...
$().ready(function() {ldelim}	
	...
	colNames: [
		...
		'{t escape=js}Nick Name{/t}',
		'{t escape=js}IP Address{/t}'
	],
	colModel: [
		{ldelim}name: 'id', index: 'id', hidden: true, width: 1{rdelim},
		{ldelim}name: 'email', width: 195{rdelim},
		{foreach from=$fields key=id item=f}{ldelim}name: 'd{$id}', width: 10{rdelim},{/foreach}
		{literal}{name: 'registered', width: 109},
		{name: 'touched', width: 110},
		{name: 'ip', width: 110}
	]
	};
