...
<span>
<!--<button onclick="window.location.href='{$smarty.server.PHP_SELF}?group_id={$id}&amp;delete=TRUE'; return false;">--><a href="{$smarty.server.PHP_SELF}?group_id={$id}&amp;delete=TRUE"<img src="{$url.theme.shared}images/icons/delete.png" alt="delete icon" /><!--</button>-->
</span>

<span>
<!--<button onclick="window.location.href='groups_edit.php?group={$id}'; return false;">--><a href="groups_edit.php?group={$id}"><img src="{$url.theme.shared}images/icons/editsm.png" alt="edit icon" /></a>
</span><!--</button>-->
