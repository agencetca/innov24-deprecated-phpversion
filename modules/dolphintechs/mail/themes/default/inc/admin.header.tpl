...
<h1><a href="{$config.site_url}"><img src="{$url.theme.shared}images/icons/mail-icon.png" alt="mail icon" /> <strong>{$config.site_name}</strong></a></h1>

</div>

<ul id="menu">
<li><a href="{$url.base}index.php?logout=TRUE">{t}Logout{/t}</a></li>
<li class="advanced"><a href="{$config.site_url}administration">{t}Dolphin Admin{/t}</a></li>
