...
class MlPageWallConfig extends BxDolConfig {
    var $_oDb;
    var $_bAllowDelete;
...
/*
	 * Constructor
	 */
	function MlPageWallConfig($aModule) {
	    parent::BxDolConfig($aModule);
	    
	    $this->_bFullCompilation = false;
	    
	    $this->_sAlertSystemName = "ml_page_wall";
	    $this->_sCommonPostPrefix = 'wall_common_';	    
	    $this->_sCommentSystemName = "ml_page_wall";
	...
	function init(&$oDb) {
	    ...
	    $this->_bAllowDelete = $this->_oDb->getParam('page_wall_enable_delete') == 'on';
	    $this->_iPerPage = (int)$this->_oDb->getParam('page_wall_events_per_page');
	    $this->_iRssLength = (int)$this->_oDb->getParam('page_wall_rss_length');
	}
