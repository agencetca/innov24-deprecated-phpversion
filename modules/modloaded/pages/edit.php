...
function PageCompPages($oMlPages)
{
	...
	if (!$iPageId)
	{
		header("location:".BX_DOL_URL_ROOT. $oMlPages->_oConfig->getBaseUri() . "home/");
		exit;
	}
	...
	$aVars = array_merge($aVars, array ('form' => $oEditPageProc->process(), 'edit_url' => $oMlPages->_oConfig->_sHomeUrl . 'edit.php', 'page_id' => $iPageId));
	...
	$oMlPages->_oTemplate->addJs(array('join.js'));
