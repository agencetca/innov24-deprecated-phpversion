...
class MlPagesCalendar extends BxDolTwigCalendar {

    var $oTemplate;

    function MlPagesCalendar ($iYear, $iMonth, &$oDb, &$oTemplate, &$oConfig) {
        parent::BxDolTwigCalendar($iYear, $iMonth, $oDb, $oConfig);
        $this->oTemplate = &$oTemplate;
    }

    function getEntriesNames () {
        return array(_t('_ml_pages_single'), _t('_ml_pages_plural'));
    }    
