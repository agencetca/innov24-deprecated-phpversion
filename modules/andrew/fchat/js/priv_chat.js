...
$(function() {
    ...
    $('.slideout_inner').mouseover(function() {
        $('body').css( "overflow", "hidden" );
    });

    $('.slideout_inner').mouseout(function() {
        $('body').css( "overflow", "scroll" );
    });
    
    $('.priv_dock_wrap').mouseover(function() {
    $('body').css( "overflow", "hidden" );
    });
    
	 $('.priv_dock_wrap').mouseout(function() {
    $('body').css( "overflow", "scroll" );
    });
...
//TIG : Changement de la fonction afcToggleMinSess(id) par la fonction afcToggleVisSess(id) pour que la fenêtre disparaisse en cas de click de la topbar
            $('.priv_chat_tab#pcid'+id+' .priv_title').bind('click', function() {
                afcToggleMinSess(id);
            });
//TIG : FIN Changement de la fonction afcToggleMinSess(id) par la fonction afcToggleVisSess(id) pour que la fenêtre disparaisse en cas de click de la topbar
            if (bFchatVim) {
                        ...
                        $.post('m/fchat/action/priv_message/', { priv_message: message,
                            ...
                            function(data){
                                ...
                                getPrivateMessages(id, function() {
                                    ...
                                    if (data != undefined && data.onl) {
                                        $('.priv_chat_tab#pcid'+id+' .priv_conv').append('<div class="anno">'+data.onl+'</div>');
                                    }
                                });
                            }, "json"
                        );
