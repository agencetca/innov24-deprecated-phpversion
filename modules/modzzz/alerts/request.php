...
class BxAlertsRequest extends BxDolRequest {

    function BxAlertsRequest() {
        parent::BxDolRequest();
    }
    ...
    function processAsAction($aModule, &$aRequest, $sClass = "Module") {
        ...
        $GLOBALS['oTopMenu']->setCustomSubActions($aVars, 'modzzz_Alerts_title', false);

        return BxDolRequest::processAsAction($aModule, $aRequest, $sClass);
    }
}

BxAlertsRequest::processAsAction($GLOBALS['aModule'], $GLOBALS['aRequest']);
