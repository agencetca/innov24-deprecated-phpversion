...
class BxCreditPageMembership extends BxDolTwigPageMain {

    function BxCreditPageMembership(&$oMain) {
		...
		parent::BxDolTwigPageMain('modzzz_credit_membership', $oMain);
	}
   
	function getBlockCode_CurrentLevels() {
	    $aUserLevel = getMemberMembershipInfo($this->oMain->_iProfileId);        
	    return $this->_oTemplate->displayCurrentLevel($aUserLevel);
	}
 
    function getBlockCode_AvailableLevels() { 
