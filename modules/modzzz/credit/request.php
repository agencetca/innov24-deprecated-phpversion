...
class BxCreditRequest extends BxDolRequest {

    function BxCreditRequest() {
        parent::BxDolRequest();
    }
    ...
    function processAsAction($aModule, &$aRequest, $sClass = "Module") {
        ...
        $GLOBALS['oTopMenu']->setCustomSubActions($aVars, 'modzzz_Credit_title', false);

        return BxDolRequest::processAsAction($aModule, $aRequest, $sClass);
    }
}

BxCreditRequest::processAsAction($GLOBALS['aModule'], $GLOBALS['aRequest']);
